...
module.exports = function(grunt) {
	...
	grunt.initConfig({
        ...
        src: ['index.html'] // check this file
	    }
		},
		...
		less: {
			build: {
				...
				files: {
					'css/adaptation.css' : 'less/combined-adaptation.less' // create a css file out of the given less file
				}
			}
		},
		...
		autoprefixer: {
			build: {
				...
				files: {
					'css/adaptation.css' : 'css/adaptation.css'
				}
			}
		},
		...
		cssmin: {
			build: {
				src: 'css/adaptation.css',
				dest: 'css/adaptation.min.css'
			}
		},
		...
		concat: {
			...
			dist: {
				src: ['uncompressed/*.js'],
				dest: 'concatenated/adaptation.js'
			}
		},
		...
		uglify: {
			my_target: {
				files: {
					'js/adaptation.min.js': 'concatenated/adaptation.js'
				}
			}
		},
